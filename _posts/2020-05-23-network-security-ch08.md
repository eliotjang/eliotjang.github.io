...
### 3-2. 응용레벨 게이트웨이(Application Level Gateway)
...
### 3-3. 회선레벨 게이트웨이(Circuit Level Gateway)
...
### 2-2. 이상(비정상) 탐지(Anomaly Detection) 모델
...
### 2-3. L2TP(Layer2 Tunneling Protocol)
